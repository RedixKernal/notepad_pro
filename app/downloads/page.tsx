    ...
    <>
      ...
      <section className="shortcuts-section" style={{ minHeight: 'calc(100vh - 100px)', paddingTop: '120px' }}>
        <div className="container">
          ...
          <div className="downloads-list reveal delay-1" style={{ marginBottom: '40px' }}>
            {downloads.map((dl, index) => (
              <div key={index} className="download-row-card">
                <div className="dl-icon-col">
                  {dl.architecture.includes('Windows') ? (
                    <svg className="os-icon win" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                      <path d="M0,3.449L9.75,2.1v9.451H0m10.949-9.602L24,0v11.4H10.949M0,12.6h9.75v9.451L0,20.699M10.949,12.6H24V24l-12.951-1.801" />
                    </svg>
                  ) : dl.architecture.includes('macOS') ? (
                    <svg className="os-icon mac" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" fill="currentColor">
                    ...
                    <svg className="os-icon lin" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" fill="currentColor">
          ...
          <div className="changelog-section reveal delay-2" style={{ marginTop: '60px' }}>
            <div style={{ textAlign: 'center', marginBottom: '40px' }}>
              <h2 style={{ fontSize: '2.5rem', marginBottom: '12px' }}>What's New in v1.1.0</h2>
            ...
            <div className="changelog-container">
              ...
              <div className="changelog-row">
                ...
                <div className="changelog-content">
                  <ol>
                    <li><span className="rn-tag rn-tag-improve" style={{ marginRight: '8px', verticalAlign: 'middle', display: 'inline-block' }}>Improvement</span> Significantly improved user experience.</li>
                    <li><span className="rn-tag rn-tag-feature" style={{ marginRight: '8px', verticalAlign: 'middle', display: 'inline-block' }}>New Feature</span> Added custom tab spacing configuration.</li>
                    <li><span className="rn-tag rn-tag-feature" style={{ marginRight: '8px', verticalAlign: 'middle', display: 'inline-block' }}>New Feature</span> Integrated terminal for live code run execution.</li>
                    <li><span className="rn-tag rn-tag-improve" style={{ marginRight: '8px', verticalAlign: 'middle', display: 'inline-block' }}>Improvement</span> Improved performance in all distributions.</li>
                  </ol>
                </div>
              </div>
              ...
              <div className="changelog-row">
                ...
                <div className="changelog-content">
                  <ol>
                    <li><span className="rn-tag rn-tag-improve" style={{ marginRight: '8px', verticalAlign: 'middle', display: 'inline-block' }}>Improvement</span> General stability and execution speed improvements.</li>
                    <li><span className="rn-tag rn-tag-fix" style={{ marginRight: '8px', verticalAlign: 'middle', display: 'inline-block' }}>Fix</span> Minor UI adjustments for Windows 10/11 environments.</li>
                  </ol>
                </div>
              </div>
              ...
              <div className="changelog-row">
                ...
                <div className="changelog-content">
                  <ol>
                    <li><span className="rn-tag rn-tag-fix" style={{ marginRight: '8px', verticalAlign: 'middle', display: 'inline-block' }}>Fix</span> Fixed critical startup problems.</li>
                    <li><span className="rn-tag rn-tag-fix" style={{ marginRight: '8px', verticalAlign: 'middle', display: 'inline-block' }}>Fix</span> Resolved struct loading issues.</li>
                    <li><span className="rn-tag rn-tag-fix" style={{ marginRight: '8px', verticalAlign: 'middle', display: 'inline-block' }}>Fix</span> Fixed the auto-close bug affecting macOS users.</li>
                  </ol>
                </div>
              </div>
              ...
              <div className="changelog-row">
                ...
                <div className="changelog-content">
                  <ol>
                    <li><span className="rn-tag rn-tag-improve" style={{ marginRight: '8px', verticalAlign: 'middle', display: 'inline-block' }}>Improvement</span> Better integration with Debian/Ubuntu window managers.</li>
                    <li><span className="rn-tag rn-tag-fix" style={{ marginRight: '8px', verticalAlign: 'middle', display: 'inline-block' }}>Fix</span> Addressed minor performance bottlenecks during code execution.</li>
                  </ol>
                </div>
              </div>
