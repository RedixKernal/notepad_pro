    ...
    <>
      ...
      <section id="download" className="hero">
        <div className="container">
          ...
          <p className="hero-subtitle reveal delay-2" style={{fontSize: '1rem'}}>
          ...
          <div className="hero-downloads reveal delay-3">
            <div className="download-card-wrapper">
              <a href="https://get.microsoft.com/installer/download/9P3BZ03WV8WG?hl=en-us&gl=us&ocid=pdpshare&referrer=storeforweb" className="btn-os btn-windows">
              ...
              <div className="download-chips">
                ...
                <span className="chip">Windows 10/11 (.msix)</span>
              </div>
            </div>
            <div className="download-card-wrapper">
      ...
      <section id="features" className="content-section">
        <div className="container">
          <div style={{ textAlign: 'center', marginBottom: '60px' }}>
            ...
            <p className="reveal delay-1" style={{ color: 'var(--text-secondary)', fontSize: '1rem', maxWidth: '600px', margin: '0 auto' }}>
