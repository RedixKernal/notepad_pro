  ...
  return (
    <>
      ...
      <section id="download" className="hero">
        <div className="container">
          <div className="reveal" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', padding: '8px 16px', background: 'linear-gradient(90deg, #8A2BE2, #4169E1)', color: 'white', borderRadius: '20px', fontSize: '0.9rem', fontWeight: 'bold', marginBottom: '24px', boxShadow: '0 4px 14px 0 rgba(138, 43, 226, 0.39)' }}>
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"></path>
            </svg>
            Now with AI-Powered Research & Development
          </div>
          <h1 className="hero-title reveal delay-1">Notepad_Pro</h1>
          <p className="hero-subtitle reveal delay-2">
            A free, open-source, lightweight notepad designed for maximum productivity and seamless execution. Now supercharged with intelligent AI to understand your context and accelerate your workflow.
          </p>

          <div className="hero-downloads reveal delay-3">
            <div className="download-card-wrapper">
              <a href="https://github.com/RedixKernal/notepad_pro_app/releases/download/v2.0.0/Notepad_Pro-2.0.0.msi" className="btn-os btn-windows">
            ...
            <div className="download-card-wrapper">
              <a href="https://github.com/RedixKernal/notepad_pro_app/releases/download/v2.0.0/Notepad_Pro-2.0.0.dmg" className="btn-os btn-macos">
            ...
            <div className="download-card-wrapper">
              <a href="https://github.com/RedixKernal/notepad_pro_app/releases/download/v2.0.0/notepad-pro_2.0.0-1_amd64.deb" className="btn-os btn-linux">
      ...
      <section id="features" className="content-section">
        <div className="container">
          ...
          <div className="features-grid">
            <div className="feature-item reveal delay-1" style={{ border: '2px solid rgba(138, 43, 226, 0.3)', position: 'relative' }}>
              <div style={{ position: 'absolute', top: '16px', right: '16px', background: 'linear-gradient(90deg, #8A2BE2, #4169E1)', color: 'white', padding: '2px 10px', borderRadius: '12px', fontSize: '0.75rem', fontWeight: 'bold', boxShadow: '0 2px 8px rgba(138,43,226,0.3)' }}>NEW</div>
              <div className="feature-icon" style={{ color: '#8A2BE2', backgroundColor: 'rgba(138, 43, 226, 0.1)' }}>
                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"></path>
                </svg>
              </div>
              <h3>AI Assistant</h3>
              <p>Ask anything about your current active tab. The AI understands your code context and helps you develop faster and more intelligently.</p>
            </div>
